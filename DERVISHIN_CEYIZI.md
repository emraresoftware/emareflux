...
```python
# Emare Flux — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emareflux.view',      # Görüntüleme
    'emareflux.create',    # Oluşturma
    'emareflux.edit',      # Düzenleme
    'emareflux.delete',    # Silme
    'emareflux.manage',    # Tam yönetim
    # Admin
    'emareflux.admin',     # Admin panele erişim
    'emareflux.users',     # Kullanıcı yönetimi
    'emareflux.settings',  # Ayar yönetimi
]
```
...
```python
# emareflux/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emareflux.view', 'emareflux.create',
        'emareflux.edit', 'emareflux.delete',
        'emareflux.manage', 'emareflux.users',
        'emareflux.settings', 'emareflux.admin',
    },
    'operator': {
        'emareflux.view', 'emareflux.create',
        'emareflux.edit',
...
| Proje Admini | admin@emareflux.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emareflux.emare.dev | super_admin | Machine-to-machine |
