# Emare Flux — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emareflux
...
| 6 | `emareflux_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emareflux Dervishi` bu projeden sorumlu
